...
/**
 * 细胞输出ID无效异常（对应 Ruby 的 Api::V1::Exceptions::CellOutputIdInvalidError）
 */
public class CellOutputIdInvalidError extends ApiError {
  // 固定错误参数（与 Ruby 中 super 传入的参数完全一致）
  private static final int CODE = 1015;
  ...
  // 无参构造器：初始化固定错误参数
  public CellOutputIdInvalidError() {
