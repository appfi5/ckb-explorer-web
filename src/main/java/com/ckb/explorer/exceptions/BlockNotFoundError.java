...
/**
 * 区块未找到异常（对应 Ruby 的 Api::V1::Exceptions::BlockNotFoundError）
 */
public class BlockNotFoundError extends ApiError {
  // 固定错误参数（与 Ruby 中 super 传入的参数完全一致）
  private static final int CODE = 1004;
  private static final int STATUS = 404;
  private static final String TITLE = "Block Not Found";
  private static final String DETAIL = "No block records found by given block hash or number";
