 ...
 * @Entity com.ckb.explore.worker.entity.DobCode
 */
@DS("risingwave")
@Mapper
public interface DobCodeMapper extends BaseMapper<DobCode> {

    @Select("select * from dob_code where dob_code_script_args = #{args}")
    DobCode findByDobCodeScriptArgs(@Param("args") byte[] args);
